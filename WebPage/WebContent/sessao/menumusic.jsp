...
<div class="page-header" >
 ...
 <form action="GoToInfoMusic">
  <button type="submit" class="btn btn-xs btn-primary">Add Music</button>
</form>
    ...
    <table class="table">
      <thead>
       ...
       <td>
        ...
        <a href="GoToEditMusic?music_id=${list.getId()}"><button type="submit" class="btn btn-xs btn-default">Edit</button><a>
